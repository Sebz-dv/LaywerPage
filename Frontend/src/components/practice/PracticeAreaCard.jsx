...
export default function PracticeAreaCard({ item }) {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        whileHover={reduceMotion ? {} : { y: -4, rotateX: 1 }}
      ...
      >
        ...
        {item.excerpt && (
          <p
            ...
            style={CLAMP ? { display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" } : undefined}
            title={item.excerpt}
          >
            {item.excerpt}
          </p>
